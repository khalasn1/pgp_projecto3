%Redefinir Requesitos - praticamente feito.
%Mudar Introdução - feito.
%Especificar Detalhaes dos Requesitos - feito.
...
\noindent{\textbf{Tabela de Competências Técnicas}}
\begin{table}[h]
\centering
...
\noindent{\textbf{Tabela de Competências Pessoais}}
\\
\begin{enumerate}
\item Comunicação
